...
#define  COB_SOURCE_FILE		"hello-dot-div.cbl"
#define  COB_PACKAGE_VERSION		"3.2"
#define  COB_PATCH_LEVEL		0
#define  COB_MODULE_FORMATTED_DATE	"Jul 25 2025 12:06:19"
#define  COB_MODULE_DATE		20250725
#define  COB_MODULE_TIME		120619

/* Global variables */
#include "hello-dot-div.c.h"
...
HELLO_ (const int entry)
{
  ...
  /* Line: 4         : Entry     HELLO                   : hello-dot-div.cbl */
  l_2:;
#line 4 "hello-dot-div.cbl"
  ENTRY_HELLO:	cob_nop ();
#line 105 "hello-dot-div.c"

  /* Line: 4         : DISPLAY            : hello-dot-div.cbl */
#line 4 "hello-dot-div.cbl"
  cob_nop ();
#line 110 "hello-dot-div.c"
  cob_display (0, 1, 1, &c_1);

  /* Line: 5         : STOP RUN           : hello-dot-div.cbl */
#line 5 "hello-dot-div.cbl"
  cob_nop ();
#line 116 "hello-dot-div.c"
  cob_stop_run (b_2);
