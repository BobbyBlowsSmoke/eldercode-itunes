...
#define  COB_SOURCE_FILE		"acceptshell.cob"
#define  COB_PACKAGE_VERSION		"3.2"
#define  COB_PATCH_LEVEL		0
#define  COB_MODULE_FORMATTED_DATE	"Jul 25 2025 13:03:22"
#define  COB_MODULE_DATE		20250725
#define  COB_MODULE_TIME		130322

/* Global variables */
#include "acceptshell.c.h"

/* Function prototypes */

static int		ACCEPTSHELL ();
static int		ACCEPTSHELL_ (const int);
static void		ACCEPTSHELL_module_init (cob_module *module);
...
ACCEPTSHELL ()
{
  return ACCEPTSHELL_ (0);
}

static int
ACCEPTSHELL_ (const int entry)
{
  /* Program local variables */
  #include "acceptshell.c.l.h"
  ...
  /* Line: 10        : Entry     ACCEPTSHELL             : acceptshell.cob */
  l_2:;
#line 10 "acceptshell.cob"
  ENTRY_ACCEPTSHELL:	cob_nop ();
#line 105 "acceptshell.c"

  /* Line: 10        : Paragraph MAIN-PARAGRAPH          : acceptshell.cob */
#line 10 "acceptshell.cob"
  PARAGRAPH_MAIN__PARAGRAPH_l_4:	cob_nop ();
#line 110 "acceptshell.c"

  /* Line: 11        : DISPLAY            : acceptshell.cob */
#line 11 "acceptshell.cob"
  cob_nop ();
#line 115 "acceptshell.c"
  cob_display (0, 1, 1, &c_1);

  /* Line: 12        : ACCEPT             : acceptshell.cob */
#line 12 "acceptshell.cob"
  cob_nop ();
#line 121 "acceptshell.c"
  cob_accept (&f_17);

  /* Line: 14        : CALL               : acceptshell.cob */
#line 14 "acceptshell.cob"
  cob_nop ();
#line 127 "acceptshell.c"
  cob_procedure_params[0] = &f_17;
  cob_glob_ptr->cob_call_params = 1;
  cob_glob_ptr->cob_stmt_exception = 0;
  b_2 = cob_sys_system (b_17);

  /* Line: 17        : DISPLAY            : acceptshell.cob */
#line 17 "acceptshell.cob"
  cob_nop ();
#line 136 "acceptshell.c"
  cob_display (0, 1, 2, &c_2, &f_2);

  /* Line: 18        : STOP RUN           : acceptshell.cob */
#line 18 "acceptshell.cob"
  cob_nop ();
#line 142 "acceptshell.c"
  cob_stop_run (b_2);
  ...
  ACCEPTSHELL_module_init (module);
...
#line 6 "acceptshell.cob"
  cob_nop ();
#line 195 "acceptshell.c"
...
/* End PROGRAM-ID 'ACCEPTSHELL' */

/* Initialize module structure for ACCEPTSHELL */
static void ACCEPTSHELL_module_init (cob_module *module)
{
  module->module_name = "ACCEPTSHELL";
  ...
  module->module_entry.funcptr = (void *(*)())ACCEPTSHELL;
  module->module_cancel.funcptr = (void *(*)())ACCEPTSHELL_;
